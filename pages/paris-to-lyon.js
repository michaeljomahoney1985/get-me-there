...
export default function ParisToLyon() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Paris to Lyon</span>
        </div>
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          ...
          <br />
          <span className="text-blue-100">TGV Guide (December 2025)</span>
        </h1>

        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          France's busiest and most reliable high-speed route—city centre to city centre in under 2 hours on SNCF TGV INOUI.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                SNCF TGV INOUI direct: 1h 55min, from €25 one-way if booked early (up to €120 last-minute). Over 20 departures daily. Book on sncf-connect.com.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">SNCF TGV INOUI Direct Train</h2>
                <p className="text-cyan-300 text-sm">France's busiest high-speed route</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">1h 55min</div>
                <div className="text-sm text-blue-300/70">Direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€25-120</div>
                <div className="text-sm text-blue-300/70">One-way (Dec 2025)</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <Train className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">20+ daily</div>
                <div className="text-sm text-blue-300/70">Gare de Lyon → Part-Dieu</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Depart Paris Gare de Lyon, arrive Lyon Part-Dieu (main station). High-speed TGV INOUI (300 km/h). Free Wi-Fi, power sockets, bar car, generous luggage allowance (no weight limit).</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>2nd Class: €25-90 (Prems early fares)</li>
                <li>1st Class: €50-120 (more space + quieter)</li>
              </ul>

              <p>Book early (up to 4 months) for cheapest Prems fares. Extremely frequent—almost hourly service.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book on sncf-connect.com for best deals</li>
                  <li>Off-peak (midday/weekdays) cheapest</li>
                  <li>Arrive 2-5 min before departure (no security)</li>
                  <li>OUIGO low-cost alternative sometimes €10-50 (but stricter luggage)</li>
                </ul>
              </div>
            </div>

            <div className="mt-8">
              <a href="https://www.sncf-connect.com/en-en/train/route/paris/lyon" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">For wider France/Europe trips</p>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on TGV INOUI. Seat reservation required (€10-20).</p>
              <p>Plenty of seats for passholders on this busy route—book ahead for peak times.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">TGV INOUI</td>
                  <td className="py-4 px-4">1h 55min</td>
                  <td className="py-4 px-4">€25-120</td>
                  <td className="py-4 px-4">Comfort & reliability</td>
                </tr>
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">OUIGO (low-cost)</td>
                  <td className="py-4 px-4">~2h</td>
                  <td className="py-4 px-4">€10-60</td>
                  <td className="py-4 px-4">Ultra-budget</td>
                </tr>
                <tr>
                  <td className="py-4 px-4 font-semibold text-cyan-300">Rail Pass</td>
                  <td className="py-4 px-4">1h 55min</td>
                  <td className="py-4 px-4">Pass + €10-20 res.</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              TGV INOUI—book early on SNCF Connect for €25-40 fares. With over 20 trains a day, it's incredibly convenient. OUIGO for ultra-low prices if you don't mind stricter rules.
            </p>
          </div>
        </section>
