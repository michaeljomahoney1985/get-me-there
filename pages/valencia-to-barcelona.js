...
export default function ValenciaToBarcelona() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Valencia to Barcelona</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Direct high-speed link along Spain's Mediterranean coast—comfortable trains connecting two vibrant cities.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct high-speed trains (AVE, Euromed, iryo): ~2h 40-3h 20min, from €20 one-way if booked early (up to €100+ last-minute). Around 12-15 departures daily. Book on renfe.com or comparison sites.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">Renfe AVE, Euromed & iryo</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~2h 40-3h 20min</div>
                <div className="text-sm text-blue-300/70">Fastest ~2h 40min</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">12-15 daily</div>
                <div className="text-sm text-blue-300/70">Joaquín Sorolla → Sants</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Direct services mainly by Renfe (AVE fastest, Euromed coastal route) and iryo. High-speed along the Mediterranean corridor, some with sea views. Wi-Fi, power sockets, cafe-bar on most.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (current 2026 prices):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Economy/Básico: €20-60 (early fares)</li>
                <li>Standard AVE/iryo: €30-80</li>
                <li>Premium/Preferente: €60-100+ (meals, lounge)</li>
              </ul>

              <p>Book early for best deals—good competition on this corridor.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  ...
                  <li>Midday trains often cheaper</li>
                  <li>Arrive 20-30 min early</li>
                  <li>Valencia Joaquín Sorolla station (temporary, close to centre)</li>
                </ul>
              </div>
            </div>

            <div className="mt-8">
              <a href="https://www.thetrainline.com/en/train-times/valencia-to-barcelona" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes valid on Renfe/iryo services. Reservation required (€10-20).</p>
              <p>Good availability—book ahead for peak seasons.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">~2h 40-3h 20min</td>
                ...
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">Similar—train better</td>
                </tr>
                <tr>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              High-speed train—book early for €20-40 fares. Relaxing coastal journey, city-centre stations, and no airport hassle make it the clear winner over flying.
            </p>
          </div>
        </section>
