...
export default function OsloToBergen() {
  return (
    <>
      <Head>
        <title>Oslo to Bergen by Train: Time, Cost & Travel Guide (2026)</title>
        <meta
          name="description"
          content="Book Oslo to Bergen train tickets from €40 with Vy. Discover 2026 schedules, cheap fares, and why the Bergen Line is consistently ranked one of the world's most beautiful rail journeys – dramatic Hardangervidda plateau, fjords, waterfalls, and alpine landscapes."
        />
        <meta property="og:title" content="Oslo to Bergen by Train: Time, Cost & Travel Guide (2026)" />
        <meta property="og:description" content="Direct Vy train from Oslo to Bergen in ~7h – epic scenery across Europe's highest railway plateau." />
        <meta property="og:url" content="https://www.get-me-there.com/oslo-to-bergen" />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Oslo to Bergen by Train: Time, Cost & Travel Guide (2026)" />
        <meta name="twitter:description" content="Direct Vy train from Oslo to Bergen in ~7h – epic scenery across Europe's highest railway plateau." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How long does the train from Oslo to Bergen take?",
                acceptedAnswer: { "@type": "Answer", text: "Direct Vy trains take around 6 hours 40 minutes to 7 hours." }
              },
              {
                "@type": "Question",
                name: "Do I need a passport for the Oslo to Bergen train?",
                acceptedAnswer: { "@type": "Answer", text: "No – domestic Norwegian route." }
              },
              {
                "@type": "Question",
                name: "Can I bring luggage or a bike?",
                acceptedAnswer: { "@type": "Answer", text: "Generous allowance: no weight limit, multiple racks. Bikes require reservation (€10–15)." }
              },
              {
                "@type": "Question",
                name: "When is the best time to book cheap tickets?",
                acceptedAnswer: { "@type": "Answer", text: "Book 3 months ahead for Minipris fares from €40." }
              },
              {
                "@type": "Question",
                name: "Which side of the train has the best views from Oslo to Bergen?",
                acceptedAnswer: { "@type": "Answer", text: "Right side (facing forward) for the most dramatic Hardangervidda plateau and fjord glimpses." }
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Oslo to Bergen by Train", item: "https://www.get-me-there.com/oslo-to-bergen" }
            ]
          })}
        </script>
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
            ...
            <span>→</span>
            <span className="text-blue-300">Oslo to Bergen</span>
          </div>
          ...
          <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
            The **Bergen Line** (Bergensbanen) is widely regarded as one of the world's most beautiful rail journeys, crossing Northern Europe's highest mainline railway. Starting in vibrant Oslo, the train climbs through forested valleys and alongside glittering lakes, before reaching the barren yet breathtaking **Hardangervidda** – Europe's largest high mountain plateau, often snow-capped even in summer, with vast tundra landscapes, roaming reindeer, and remote stations like Finse at 1,222 metres. The descent into western Norway reveals dramatic fjords, thundering waterfalls cascading down sheer cliffs, deep gorges, and lush green valleys leading to colourful Bergen on the coast. This epic 7-hour adventure showcases Norway's wild diversity – from alpine plateaus to coastal fjords – in one unforgettable ride, perfect for nature lovers seeking a relaxing yet awe-inspiring alternative to flying.
          </p>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/60 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-blue-100">Direct Bergen Line Train</h2>
                <p className="text-cyan-300 text-sm">Vy (Norwegian State Railways)</p>
              </div>

              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <Clock className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
                  <p className="text-3xl font-bold text-white">~7h</p>
                  <p className="text-blue-300 text-sm">Direct</p>
                </div>
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <p className="text-3xl font-bold text-white">€40–120</p>
                  <p className="text-blue-300 text-sm">One-way (2026 advance fares)</p>
                </div>
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <p className="text-3xl font-bold text-white">5–7 daily</p>
                  <p className="text-blue-300 text-sm">From Oslo Sentral</p>
                </div>
              </div>

              <p className="text-blue-200/90 leading-relaxed mb-6">
                The legendary Bergensbanen – consistently ranked among the world's most spectacular rail journeys – crosses Europe's highest mainline railway over Hardangervidda with unforgettable mountain, plateau, and fjord scenery.
              </p>
              ...
              <div className="bg-slate-800/60 rounded-2xl p-6">
                ...
                <ul className="text-blue-200/90 space-y-2 text-sm">
                  <li>Sit on the right side (from Oslo) for the most dramatic Hardangervidda and fjord views</li>
                  <li>Seat reservation recommended in peak summer (€5–10)</li>
                  <li>Onboard café serves Norwegian waffles and coffee</li>
                  <li>Book early for Minipris fares (limited availability)</li>
                </ul>
              </div>
            </div>
          </section>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-blue-200/80">
                  <tr className="border-b border-blue-400/10">
                    ...
                    <td className="py-4 px-4">~7h</td>
                    <td className="py-4 px-4">€40–120+</td>
                    <td className="py-4 px-4">Scenic experience of a lifetime</td>
                  </tr>
                  <tr className="border-b border-blue-400/10">
                    <td className="py-4 px-4 font-semibold text-cyan-300">Bus (Vy/Nor-Way)</td>
                    <td className="py-4 px-4">10–12h</td>
                    <td className="py-4 px-4">€50–80</td>
                    <td className="py-4 px-4">Budget, but much longer</td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-4 px-4">Speed, but misses the scenery</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="mb-12">
            ...
            <p className="text-blue-200/80 leading-relaxed">
              5–7 direct departures daily from Oslo Sentralstasjon to Bergen. First trains ~6am, last ~11pm (night train option). Journey time 6h40m–7h.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-3">
              ...
              <li>Comfort+ class offers larger seats and meals.</li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              <p className="text-blue-200/80 leading-relaxed mb-6">
                The train climbs from Oslo through forests to Europe's highest mainline station at Finse (1,222m), crosses the barren Hardangervidda plateau, then descends past waterfalls and fjords to Bergen.
              </p>
              <p className="text-blue-200/80 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><strong>Scenic Enthusiasts:</strong> Regularly voted world's most beautiful train journey.</li>
              <li><strong>Fjord & Nature Lovers:</strong> Unforgettable mountain and plateau views.</li>
              <li><strong>Photographers:</strong> Endless dramatic landscapes.</li>
              <li><strong>Relaxing Travelers:</strong> Comfortable day journey with café onboard.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-blue-200/80 leading-relaxed mb-6">
              Spectacular year-round: summer green valleys, autumn colours, winter snow-covered plateau (Finse often deep in snow). Clear days best for visibility.
            </p>
            <p className="text-blue-200/80 leading-relaxed mb-8">
              Right side (facing forward) for the most iconic Hardangervidda and fjord views.
            </p>
            <p className="text-blue-200/80 leading-relaxed">
              Once in Bergen, the adventure can continue by boat – popular fjord cruises depart from the harbour to Sognefjord, Hardangerfjord, or shorter routes to nearby islands.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                Explore fjord cruises from Bergen
              </a>
            </div>
          </section>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              ...
              <div className="space-y-4 text-blue-200/80 leading-relaxed">
                <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on Vy trains with mandatory seat reservation (€5–10).</p>
                <p>Popular route – book reservations early in summer.</p>
              </div>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><a href="/bergen-to-oslo" className="text-cyan-300 hover:text-cyan-400">Bergen to Oslo (reverse journey)</a></li>
