...
export default function MadridToMalaga() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Madrid to Malaga</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Spain's popular high-speed route from the capital to the Costa del Sol—direct trains with multiple operators for great choice and value.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct high-speed trains (AVE, iryo, OUIGO/Avlo): ~2h 40min, from €15-30 one-way if booked early (up to €150+ last-minute). Around 18-20 departures daily. Book on renfe.com or competitors.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">Renfe AVE, iryo & Low-Cost (OUIGO/Avlo)</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~2h 40min</div>
                <div className="text-sm text-blue-300/70">Fastest direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€15-150</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Atocha → María Zambrano</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Competition between Renfe AVE (premium), iryo (modern), and low-cost OUIGO/Avlo keeps prices low. High-speed (up to 310 km/h), Wi-Fi, power sockets, cafe-bar on most.</p>

              <p className="font-semibold text-cyan-300">Prices & Options (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Low-cost (OUIGO/Avlo/iryo Básico): €15-60 (early, stricter luggage)</li>
                <li>Standard AVE/iryo: €30-100</li>
                <li>Premium/Preferente: €80-150+ (meals, lounge)</li>
              </ul>

              <p>Book early for cheapest fares—dynamic pricing across operators.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Compare renfe.com, iryo.eu, ouigo.com</li>
                  <li>Midweek/off-peak cheapest</li>
                  <li>Arrive 20-30 min early (security on some)</li>
                  <li>Free Cercanías connection often included</li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes valid on AVE/iryo (OUIGO extra). Reservation mandatory (€10-25).</p>
              <p>High demand—book early for this route.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">€15-150</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              High-speed train—shop around operators for €15-40 early fares. Competition makes this one of Spain's best-value routes, faster and easier than flying.
            </p>
          </div>
        </section>
