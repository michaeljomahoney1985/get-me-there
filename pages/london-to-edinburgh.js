    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          ...
          <br />
          <span className="text-blue-100">LNER Azuma Guide (current 2026 prices)</span>
        </h1>

        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Iconic East Coast Main Line journey—high-speed Azuma trains from London King's Cross to Edinburgh Waverley, with stunning coastal views.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                LNER Azuma direct: ~4h 20min, from £30 one-way if booked early (up to £150+ last-minute). Around 30-40 departures daily. Book on lner.co.uk.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">LNER Azuma Direct Train</h2>
                <p className="text-cyan-300 text-sm">Fastest & most frequent UK intercity route</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~4h 20min</div>
                <div className="text-sm text-blue-300/70">Fastest direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">£30-150</div>
                <div className="text-sm text-blue-300/70">One-way (current 2026 prices)</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <Train className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">30-40 daily</div>
                <div className="text-sm text-blue-300/70">King's Cross → Waverley</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Modern LNER Azuma trains (up to 125 mph). Scenic route along the North Sea coast past Durham Cathedral and Berwick. Free Wi-Fi, power sockets, at-seat service in First Class.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (current 2026 prices):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Standard: £30-100 (Advance early fares)</li>
                <li>First Class: £80-150+ (lounge access, meals)</li>
              </ul>

              <p>Book early for Advance tickets—prices rise sharply closer to departure.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book on lner.co.uk for best deals</li>
                  <li>Off-peak/midweek cheaper</li>
                  <li>Sit on right side for coastal views</li>
                  <li>LNER Perks for regular travellers</li>
                </ul>
              </div>
            </div>

            <div className="mt-8">
              <a href="https://www.lner.co.uk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Book on LNER.co.uk
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">BritRail Pass</h2>
                <p className="text-cyan-300 text-sm">For UK rail exploration</p>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>BritRail Pass (non-UK residents) covers LNER—no reservation needed on this route.</p>
              <p>Great value if combining with other UK trips.</p>
            </div>

            <div className="mt-8">
              <a href="https://www.britrail.net" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">LNER Train</td>
                  <td className="py-4 px-4">~4h 20min</td>
                  <td className="py-4 px-4">£30-150</td>
                ...
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">Similar—train wins</td>
                </tr>
                <tr>
                  <td className="py-4 px-4 font-semibold text-cyan-300">BritRail Pass</td>
                  <td className="py-4 px-4">~4h 20min</td>
                  <td className="py-4 px-4">Pass cost</td>
                  <td className="py-4 px-4">Multi-trip UK</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              LNER Azuma—book early on lner.co.uk for £30-50 Advance fares. Stunning coastal views, city-centre arrival, and far more relaxing than flying.
            </p>
          </div>
        </section>
