...
export default function SevilleToMalaga() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Seville to Málaga</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Fast, direct high-speed connection between two of Andalusia's most popular cities—perfect for combining culture and Costa del Sol beaches.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct high-speed AVE trains: ~1h 55min-2h 10min, from €20 one-way if booked early (up to €80 last-minute). Around 15-20 departures daily. Book on renfe.com.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">Direct AVE Trains</h2>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~1h 55-2h 10min</div>
                <div className="text-sm text-blue-300/70">Direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€20-80</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Santa Justa → María Zambrano</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Renfe AVE high-speed trains (up to 310 km/h) with stops in Córdoba and Antequera. Comfortable, Wi-Fi, power sockets, cafe-bar.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (current 2026 prices):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Básico: €20-50 (early fares)</li>
                <li>Elige: €30-60</li>
                <li>Prémium: €50-80 (meals, lounge access)</li>
              </ul>

              <p>Book early for lowest fares—very frequent service makes flexibility easy.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book direct on renfe.com for best deals</li>
                  <li>Midday/off-peak cheaper</li>
                  <li>Arrive 20 min early</li>
                  <li>Málaga María Zambrano station (city centre)</li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes valid on AVE. Seat reservation mandatory (€10-15).</p>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">AVE Train</td>
                  <td className="py-4 px-4">~1h 55-2h 10min</td>
                  <td className="py-4 px-4">€20-80</td>
                  <td className="py-4 px-4">Speed & comfort</td>
                </tr>
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">Bus</td>
                  <td className="py-4 px-4">~2h 30-3h</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              AVE high-speed train—book early on renfe.com for €20-30 fares. Fast, frequent, and far more comfortable than bus or driving on this short Andalusian hop.
            </p>
          </div>
        </section>
