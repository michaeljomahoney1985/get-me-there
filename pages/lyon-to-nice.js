...
export default function LyonToNice() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Lyon to Nice</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Scenic high-speed journey from central France to the French Riviera—stunning views of the Rhône Valley and Provence.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct TGV INOUI high-speed trains: ~4h 30-5h, from €29 one-way if booked early (up to €120 last-minute). Around 8-12 departures daily. Book via comparison for best deals.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~4h 30-5h</div>
                <div className="text-sm text-blue-300/70">Direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€29-120</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Part-Dieu → Nice-Ville</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Direct high-speed TGV INOUI trains operated by SNCF. Scenic route through the Rhône Valley, Provence landscapes, and approaching the Côte d'Azur. Free Wi-Fi, power sockets, cafe-bar.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (current 2026 prices):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>2nd Class: €29-80 (early fares)</li>
                <li>1st Class: €60-120+ (more space, quieter)</li>
              </ul>

              <p>Book early—dynamic pricing means big savings on advance tickets.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Sit on right side for best views southbound</li>
                  <li>Arrive 30 min early (boarding gates close early)</li>
                  <li>Lyon Part-Dieu station (main hub)</li>
                  <li>Nice-Ville (central, close to beach)</li>
                </ul>
              </div>
            </div>

            <div className="mt-8 space-y-4">
              <a href="https://www.thetrainline.com/en/train-times/lyon-to-nice" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Compare & Book on Trainline
                <Train className="w-5 h-5" />
              </a>
              <a href="https://www.omio.com/trains/lyon/nice" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-6 py-3 text-cyan-300 hover:text-cyan-200 underline">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes valid on TGV INOUI. Seat reservation mandatory (€20-30, limited seats).</p>
              <p>Book reservations early—very popular route.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">~4h 30-5h</td>
                  <td className="py-4 px-4">€29-120</td>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4">Pass + €20-30 res.</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              TGV INOUI—book early for €29+ fares. Stunning Provence views, city-centre arrival in Nice, and far more relaxing than flying on this beautiful route.
            </p>
          </div>
        </section>
