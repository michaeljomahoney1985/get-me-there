...
export default function BarcelonaToMadrid() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Barcelona to Madrid</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Spain's busiest and most competitive high-speed route—direct trains from Barcelona Sants to Madrid Atocha in around 2.5 hours.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct high-speed trains (Renfe AVE, iryo, OUIGO): ~2h 30-45min, from €30 one-way if booked early (up to €150+ last-minute). Over 25 departures daily. Book on renfe.com or competitors.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">Renfe AVE & Competitors (iryo, OUIGO/Avlo)</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">2h 30-45min</div>
                <div className="text-sm text-blue-300/70">Direct (fastest ~2h 30min)</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">25+ daily</div>
                <div className="text-sm text-blue-300/70">Sants → Atocha</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Multiple operators compete on Spain's flagship route: Renfe AVE (premium), iryo (modern comfort), OUIGO/Avlo (low-cost). All direct, high-speed (up to 310 km/h). Wi-Fi, power sockets, cafe-bar on most.</p>

              <p className="font-semibold text-cyan-300">Prices & Options (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Low-cost (OUIGO/Avlo/iryo Básico): €30-80 (early, stricter luggage)</li>
                <li>Standard AVE/iryo: €40-120</li>
                <li>Premium/Preferente: €80-150+ (meals, lounge access)</li>
              </ul>

              <p>Book early (up to 6 months) for cheapest fares—dynamic pricing means big savings.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Compare on thetrainline.com or renfe.com/iryo.com</li>
                  <li>Midweek/off-peak cheapest</li>
                  <li>Arrive 20-30 min early (security checks)</li>
                  <li>Free Cercanías connection included with many tickets</li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on Renfe AVE/iryo (OUIGO extra fee). Seat reservation mandatory (€10-25 depending on operator/class).</p>
              <p>High demand—book reservations early for this popular route.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">~2h 30-45min</td>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4">~2h 30min</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              High-speed train every time—book early across operators for €30+ fares. Competition keeps prices low; train is faster door-to-door and far more convenient than flying.
            </p>
          </div>
        </section>
