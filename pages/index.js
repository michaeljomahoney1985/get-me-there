...
export default function Home() {
  ...
  const popularRoutes = [
    ...
    { from: 'Munich', to: 'Vienna', slug: 'munich-to-vienna', icon: Mountain },
    { from: 'Munich', to: 'Zurich', slug: 'munich-to-zurich', icon: Mountain },
    { from: 'Berlin', to: 'Munich', slug: 'berlin-to-munich', icon: Mountain },
    { from: 'Munich', to: 'Geneva', slug: 'munich-to-geneva', icon: Mountain },
    { from: 'Munich', to: 'Bern', slug: 'munich-to-bern', icon: Mountain },
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Plan safe, reliable journeys anywhere in the world – trains, buses, flights, road trips, Alpine adventures, backpacking routes and more. Detailed guides, real prices and trusted tips." />
      </Head>

      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
        {/* Header with Logo + "Find your perfect route" */}
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-200 mb-16 max-w-4xl mx-auto leading-relaxed">
            Trains across Europe • Scenic Alpine journeys • Road trips • Backpacking routes • Japan rail • Flights • Buses<br />
            Detailed guides with real prices, safety tips, and the best ways to get there – no matter where "there" is.
          </p>

          {/* Search Form – example changed to Geneva */}
          ...
          <div className="max-w-5xl mx-auto">
              ...
              {popularRoutes.map((route) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <route.icon className="w-12 h-12 text-cyan-400" />
            ...
            <p className="mt-16 text-blue-200 text-lg max-w-3xl mx-auto">
              Hundreds more routes coming: Japan Shinkansen • USA road trips • Southeast Asia backpacking • Alpine hiking • Worldwide adventures • and beyond.
            </p>
          </div>
        </div>
