...
export default function MarseilleToLyon() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Marseille to Lyon</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Fast, frequent high-speed connection linking the Mediterranean south to France's gastronomic capital.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct TGV INOUI high-speed trains: ~1h 40min, from €19 one-way if booked early (up to €100+ last-minute). Around 20-25 departures daily. Book via comparison for best deals.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">€19-100</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">St-Charles → Part-Dieu</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Direct high-speed TGV INOUI trains operated by SNCF. Route through Provence and the Rhône Valley. Free Wi-Fi, power sockets, cafe-bar.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (current 2026 prices):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>2nd Class: €19-70 (early fares)</li>
                <li>1st Class: €50-100+ (more space, quieter)</li>
              </ul>

              <p>Book early—dynamic pricing means huge savings on advance tickets.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Sit on right side for best views northbound</li>
                  <li>Arrive 30 min early (boarding gates close early)</li>
                  <li>Marseille St-Charles (central)</li>
                  <li>Lyon Part-Dieu (main hub)</li>
                </ul>
              </div>
            </div>

            <div className="mt-8 space-y-4">
              <a href="https://www.thetrainline.com/en/train-times/marseille-to-lyon" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Compare & Book on Trainline
                <Train className="w-5 h-5" />
              </a>
              <a href="https://www.omio.com/trains/marseille/lyon" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-6 py-3 text-cyan-300 hover:text-cyan-200 underline">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes valid on TGV INOUI. Seat reservation mandatory (€10-20).</p>
              <p>High availability—book reservations ahead for peak times.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">€19-100</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              TGV INOUI—book early for €19+ fares. Super-fast, frequent, and city-centre to city-centre. The clear best way to travel between Marseille and Lyon.
            </p>
          </div>
        </section>
