...
export default function AmsterdamToBrussels() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Amsterdam to Brussels</span>
        </div>
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          ...
          <br />
          <span className="text-blue-100">Eurostar & Intercity Guide (December 2025)</span>
        </h1>

        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Fast and frequent connections from Amsterdam Centraal to Brussels-Midi/Zuid—choose high-speed Eurostar or affordable Intercity services.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Eurostar (fastest): 1h 52min, €29-150+. Intercity/Eurocity Direct (cheaper): ~2h-3h, lower fares. Up to 30+ daily trains combined.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">Eurostar High-Speed Train</h2>
                <p className="text-cyan-300 text-sm">The fastest option</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">1h 52min</div>
                <div className="text-sm text-blue-300/70">Direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€29-150</div>
                <div className="text-sm text-blue-300/70">One-way (Dec 2025)</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <Train className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">~15 daily</div>
                <div className="text-sm text-blue-300/70">From Centraal</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>High-speed Eurostar (former Thalys) from Amsterdam Centraal to Brussels-Midi/Zuid. Comfortable, Wi-Fi, power sockets, bar car.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Standard: €29-100+ (book early for lowest)</li>
                <li>Comfort/Premier: higher comfort + meal</li>
                <li>Business Premier: flexible + lounge</li>
              </ul>

              <p>Book early for cheapest fares—prices rise closer to departure.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book on eurostar.com</li>
                  <li>Midweek cheaper</li>
            ...
            <div className="mt-8">
              <a href="https://www.eurostar.com/uk-en/train/amsterdam-to-brussels" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">Intercity / Eurocity Direct</h2>
                <p className="text-cyan-300 text-sm">Budget-friendly alternative</p>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Slower but cheaper NS/SNCB Intercity or new Eurocity Direct services (~2h-3h journey). No reservation needed, frequent departures.</p>
              <p>Great value for flexible travel—often lower fixed fares.</p>
            </div>

            <div className="mt-8">
              <a href="https://www.nsinternational.com/en" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Book Intercity Tickets
                <Train className="w-5 h-5" />
              </a>
            </div>
          </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">1h 52min</td>
                  <td className="py-4 px-4">€29-150</td>
                  <td className="py-4 px-4">Speed & comfort</td>
                </tr>
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">Intercity</td>
                  <td className="py-4 px-4">~2-3h</td>
                  <td className="py-4 px-4">Lower/cheaper</td>
                  <td className="py-4 px-4">Budget & flexibility</td>
                </tr>
                <tr>
                  <td className="py-4 px-4 font-semibold text-cyan-300">Flying</td>
                  <td className="py-4 px-4">~4h total</td>
                  <td className="py-4 px-4">Similar</td>
                  <td className="py-4 px-4">Not recommended</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Eurostar for speed and comfort—book early for €29 fares. Intercity if saving money or needing flexibility. Train beats flying every time on this short route.
            </p>
          </div>
        </section>
