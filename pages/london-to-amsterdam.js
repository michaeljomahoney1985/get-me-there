...
export default function LondonToAmsterdam() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">London to Amsterdam</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          The high-speed Eurostar journey from London to Amsterdam—city centre to city centre in under 4 hours. Via Brussels, direct service started 2018.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Eurostar direct train: 3h 52min, from £39 one-way if booked early (up to £200 last-minute). 3-4 departures daily. Book direct on eurostar.com.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">3h 52min</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">3-4 daily</div>
                <div className="text-sm text-blue-300/70">From St Pancras</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Depart London St Pancras International, arrive Amsterdam Centraal. High-speed through the Channel Tunnel (300 km/h). Free Wi-Fi, power sockets, generous luggage allowance (2 large bags + hand luggage, no weight limit).</p>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">3h 52min</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Eurostar every time—book early on eurostar.com for £39 fares. It's faster door-to-door than flying, more relaxing, and you arrive in the heart of Amsterdam.
            </p>
          </div>
        </section>
