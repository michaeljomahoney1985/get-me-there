...
export default function BergenToOslo() {
  return (
    <>
      <Head>
        <title>Bergen to Oslo by Train: Time, Cost & Travel Guide (2026)</title>
        <meta
          name="description"
          content="Book Bergen to Oslo train tickets from €40 with Vy. Discover 2026 schedules, cheap fares, reverse Bergen Line route, tips, and why this is consistently ranked one of the world's most beautiful rail journeys."
        />
        <meta property="og:title" content="Bergen to Oslo by Train: Time, Cost & Travel Guide (2026)" />
        <meta property="og:description" content="Direct Vy train from Bergen to Oslo in ~7h – scenic masterpiece through fjords, mountains, and Hardangervidda plateau." />
        <meta property="og:url" content="https://www.get-me-there.com/bergen-to-oslo" />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Bergen to Oslo by Train: Time, Cost & Travel Guide (2026)" />
        <meta name="twitter:description" content="Direct Vy train from Bergen to Oslo in ~7h – scenic masterpiece through fjords, mountains, and Hardangervidda plateau." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How long does the train from Bergen to Oslo take?",
                acceptedAnswer: { "@type": "Answer", text: "Direct Vy trains take around 6 hours 40 minutes to 7 hours." }
              },
              {
                "@type": "Question",
                name: "Do I need a passport for the Bergen to Oslo train?",
              ...
              {
                "@type": "Question",
                name: "Which side of the train has the best views from Bergen to Oslo?",
                acceptedAnswer: { "@type": "Answer", text: "Left side (facing forward) for the most dramatic fjord and plateau views." }
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Bergen to Oslo by Train", item: "https://www.get-me-there.com/bergen-to-oslo" }
            ]
          })}
        </script>
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
            ...
            <span>→</span>
            <span className="text-blue-300">Bergen to Oslo</span>
          </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/60 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              ...
              <div className="bg-slate-800/60 rounded-2xl p-6">
                ...
                <ul className="text-blue-200/90 space-y-2 text-sm">
                  <li>Sit on the left side (from Bergen) for the most dramatic fjord and plateau views</li>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-6">Bergen to Oslo Schedule</h2>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><strong>Scenic Enthusiasts:</strong> Reverse perspective of the world's most beautiful train journey.</li>
              <li><strong>Fjord & Mountain Lovers:</strong> Dramatic ascent from sea level to high plateau.</li>
              <li><strong>Returning Travelers:</strong> Perfect way back from western Norway.</li>
              <li><strong>Photographers:</strong> Endless landscapes in changing light.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-8">FAQs About Bergen to Oslo Train</h2>
            <div className="space-y-6">
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">How long does the train from Bergen to Oslo take?</summary>
              ...
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                ...
                <p className="mt-4 text-blue-200/80">Left side for fjords and Hardangervidda plateau.</p>
              </details>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <a
                href="https://www.omio.com/trains/bergen/oslo"
                target="_blank"
                rel="nofollow noopener"
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><a href="/oslo-to-bergen" className="text-cyan-300 hover:text-cyan-400">Oslo to Bergen (reverse journey)</a></li>
