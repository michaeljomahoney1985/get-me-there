...
export default function MalagaToBarcelona() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Málaga to Barcelona</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Direct high-speed connection from the Costa del Sol to Catalonia—comfortable trains linking beaches and culture.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct high-speed trains (AVE, iryo): ~5h 30-6h, from €30 one-way if booked early (up to €180 last-minute). Around 6-8 departures daily. Book on renfe.com or iryo.eu.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~5h 30-6h</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">María Zambrano → Sants</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Direct high-speed services by Renfe AVE and iryo. Route passes through Córdoba and Madrid (change of direction, no platform change). Wi-Fi, power sockets, cafe-bar.</p>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Premium/Preferente/Infinita: €100-180+ (meals, lounge)</li>
              </ul>

              <p>Book early—competition between operators keeps prices reasonable.</p>
            ...
            <div className="mt-8">
              <a href="https://www.thetrainline.com/en/train-times/malaga-to-barcelona" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              ...
              <p>Limited seats—book well in advance.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">~5h 30-6h</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Direct high-speed train—book early across AVE and iryo for €30+ fares. Relaxing journey with no airport hassle, perfect for combining beach and city vibes.
            </p>
          </div>
        </section>
