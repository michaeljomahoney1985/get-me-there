...
export default function OsloToStockholm() {
  return (
    <>
      <Head>
        <title>Oslo to Stockholm by Train: Time, Cost & Travel Guide (2026)</title>
        <meta
          name="description"
          content="Book Oslo to Stockholm train tickets from €25 with Vy or SJ. Discover 2026 schedules, cheap fares, direct routes through Norwegian and Swedish countryside, tips, and why this relaxed Nordic link is perfect for Scandinavian adventures."
        />
        <meta property="og:title" content="Oslo to Stockholm by Train: Time, Cost & Travel Guide (2026)" />
        <meta property="og:description" content="Direct Vy/SJ from Oslo to Stockholm in ~5h30m – scenic forests, lakes, and hills." />
        <meta property="og:url" content="https://www.get-me-there.com/oslo-to-stockholm" />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Oslo to Stockholm by Train: Time, Cost & Travel Guide (2026)" />
        <meta name="twitter:description" content="Direct Vy/SJ from Oslo to Stockholm in ~5h30m – scenic forests, lakes, and hills." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How long does the train from Oslo to Stockholm take?",
                acceptedAnswer: { "@type": "Answer", text: "Direct trains take around 5 hours 30 minutes on most services." }
              },
              {
                "@type": "Question",
                name: "Do I need a passport for the Oslo to Stockholm train?",
              ...
              },
              {
                ...
                acceptedAnswer: { "@type": "Answer", text: "Generous allowance on Vy/SJ trains; bikes require reservation (€10–15)." }
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                name: "Which side of the train has the best views from Oslo to Stockholm?",
                acceptedAnswer: { "@type": "Answer", text: "Left side (facing forward) for lakes, forests, and glimpses of Swedish countryside." }
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Oslo to Stockholm by Train", item: "https://www.get-me-there.com/oslo-to-stockholm" }
            ]
          })}
        </script>
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
            ...
            <span>→</span>
            <span className="text-blue-300">Oslo to Stockholm</span>
          </div>
          ...
          <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
            The relaxed Nordic rail link connects vibrant Oslo with elegant Stockholm through beautiful Norwegian and Swedish forests and lakes. Operated jointly by Vy and SJ, this comfortable journey is perfect for Scandinavian city-hopping, nature lovers, or exploring two iconic capitals without flying.
          </p>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/60 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-cyan-300 text-sm">Vy & SJ</p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <p className="text-3xl font-bold text-white">4–6 daily</p>
                  <p className="text-blue-300 text-sm">From Oslo Sentral</p>
                </div>
              </div>

              <p className="text-blue-200/90 leading-relaxed mb-6">
                Comfortable direct trains jointly operated by Vy (Norway) and SJ (Sweden). Scenic route through forests, lakes, and rolling hills – a relaxing Nordic classic.
              </p>
              ...
              <div className="bg-slate-800/60 rounded-2xl p-6">
                ...
                <ul className="text-blue-200/90 space-y-2 text-sm">
                  <li>Sit on the left side (from Oslo) for best lake and forest views</li>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-blue-200/80">
                  <tr className="border-b border-blue-400/10">
                    <td className="py-4 px-4 font-semibold text-cyan-300">Train (Vy/SJ direct)</td>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-6">Oslo to Stockholm Schedule</h2>
            <p className="text-blue-200/80 leading-relaxed">
              4–6 direct departures daily from Oslo Sentralstasjon to Stockholm Central. First trains ~6am, last ~5pm. Journey time consistently around 5h30m.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-blue-200/80 leading-relaxed mb-6">
              Advance tickets from €25–40 when booked early. Standard fares €70–100. Book 3–6 months ahead for lowest prices on Vy.no or SJ.se.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              <p className="text-blue-200/80 leading-relaxed mb-6">
                Comfortable trains wind through central Norway and into Sweden with views of dense forests, lakes, and rolling hills.
              </p>
              <p className="text-blue-200/80 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><strong>Scandinavian Hoppers:</strong> Easy link between Oslo and Stockholm.</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-blue-200/80 leading-relaxed mb-6">
              Lovely route through Nordic nature. Summer green forests, autumn vibrant colours, winter possible snow.
            </p>
            <p className="text-blue-200/80 leading-relaxed mb-8">
              Left side (facing forward) for best lake and forest views.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <a
                href="https://www.omio.com/trains/oslo/stockholm"
                target="_blank"
                rel="nofollow noopener"
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              ...
              <div className="space-y-4 text-blue-200/80 leading-relaxed">
                <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on Vy/SJ trains with mandatory seat reservation (€5–10).</p>
                <p>Limited passholder seats—book early via Vy/SJ or rail.cc.</p>
              </div>
          ...
          {/* FAQs – now below Booking & Eurail */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-8">FAQs About Oslo to Stockholm Train</h2>
            <div className="space-y-6">
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">How long does the train from Oslo to Stockholm take?</summary>
              ...
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                ...
                <p className="mt-4 text-blue-200/80">Left side for lakes and forests.</p>
              </details>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><a href="/stockholm-to-oslo" className="text-cyan-300 hover:text-cyan-400">Stockholm to Oslo (reverse)</a></li>
