...
export default function ParisToBarcelona() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Paris to Barcelona</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Direct high-speed train from Paris Gare de Lyon to Barcelona Sants—city centre to city centre through beautiful French and Spanish countryside.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct TGV INOUI / AVE: 6h 25min, from €39 one-way if booked early (up to €200 last-minute). 2-3 departures daily. Book on sncf-connect.com or renfe.com.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">Renfe-SNCF Cooperation (TGV INOUI / AVE)</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">6h 25min</div>
                <div className="text-sm text-blue-300/70">Direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€39-200</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Gare de Lyon → Sants</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Comfortable high-speed service jointly operated by SNCF (France) and Renfe (Spain). Scenic route through southern France, past the Pyrenees, and into Catalonia.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>2nd Class (Segunda/2ème): €39-130 (Prems/early fares)</li>
                <li>1st Class (Preferente/1ère): €70-200 (more space + meal option)</li>
              </ul>

              <p>Book as early as possible (up to 4-6 months) for cheapest Prems fares. Prices rise sharply closer to departure.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book on sncf-connect.com or renfe.com (same prices)</li>
                  <li>Morning and midday trains often cheaper</li>
                  <li>Seat selection available (window recommended)</li>
                  <li>Onboard bar car for snacks & drinks</li>
                </ul>
              </div>
            </div>

            <div className="mt-8">
              <a href="https://www.sncf-connect.com/en-en/train/route/paris/barcelona" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on this route. Mandatory seat reservation required (€10-20 depending on class).</p>
              <p>Limited seats for passholders—book well in advance, especially in summer.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">6h 25min</td>
                  <td className="py-4 px-4">€39-200</td>
                  <td className="py-4 px-4">Comfort & scenery</td>
                </tr>
                <tr className="border-b border-blue-400/10">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Take the direct high-speed train—book early on SNCF Connect or Renfe for €39-60 fares. Far more relaxing than flying, with beautiful views of southern France and the Mediterranean coast.
            </p>
          </div>
        </section>
