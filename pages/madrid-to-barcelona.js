...
export default function MadridToBarcelona() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Madrid to Barcelona</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Spain's most competitive and frequent high-speed route—multiple operators offering direct services between the capital and Catalonia.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct high-speed trains (AVE, iryo, Ouigo/Avlo): ~2h 30-45min, from €15 one-way if booked early (up to €150+ last-minute). Over 25 departures daily. Book on renfe.com, iryo.eu, or ouigo.com.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Fastest ~2h 30min</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Atocha → Sants</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Heavy competition on Spain's flagship route: Renfe AVE (premium), iryo (modern comfort), Ouigo/Avlo (low-cost). All direct, high-speed (up to 310 km/h). Wi-Fi, power sockets, cafe-bar on most.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Compare across operators (Trainline easiest)</li>
            ...
            <div className="mt-8">
              <a href="https://www.thetrainline.com/en/train-times/madrid-to-barcelona" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              High-speed train—shop around AVE, iryo, and Ouigo for €15-40 early fares. Competition makes this one of Europe's best-value routes, faster door-to-door than flying.
            </p>
          </div>
        </section>
