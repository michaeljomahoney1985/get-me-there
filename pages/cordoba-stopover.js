...
export default function CordobaStopover() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Córdoba Stopover Guide</span>
        </div>
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          ...
          <br />
          <span className="text-blue-100">On Madrid-Seville Trains (current 2026 prices)</span>
        </h1>

        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Turn your Madrid-Seville journey into a highlight—stop in UNESCO-listed Córdoba for its stunning Mezquita-Catedral and historic charm.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Break Madrid-Seville trip with 4-8 hours in Córdoba. Buy separate tickets (Madrid→Córdoba + Córdoba→Seville). Total extra cost €10-30 if booked early. Frequent trains—easy planning.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <h2 className="text-3xl font-bold text-blue-100 mb-6">How to Book the Stopover</h2>
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>No official stopover ticket—buy two separate journeys:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Madrid Atocha → Córdoba Central (~1h40min)</li>
                <li>Córdoba → Seville Santa Justa (~45min)</li>
              </ul>
              <p>Book on renfe.com, iryo.eu, or thetrainline.com (compares both). Frequent departures make flexible timings easy.</p>
              <p className="font-semibold text-cyan-300">Luggage: No lockers at station—use bus station opposite (€5-10/day) or Stasher/Nannybag drop-offs nearby.</p>
              <p>Station to centre: ~20min walk or 10min taxi (€8-12).</p>
            </div>

            <div className="mt-8">
              <a href="https://www.thetrainline.com/en/train-times/madrid-to-cordoba" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Search Madrid → Córdoba
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-blue-100 mb-6">Top Sights</h2>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              4-7 hour stopover is ideal—focus on Mezquita (book tickets!) + Jewish Quarter wander + Roman Bridge photos. Even a short visit makes the trip unforgettable. Overnight if you can!
            </p>
          </div>
        </section>
