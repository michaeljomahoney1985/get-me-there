...
export default function HamburgToCopenhagen() {
  return (
    <>
      <Head>
        <title>Hamburg to Copenhagen by Train: Time, Cost & Travel Guide (2026)</title>
        <meta
          name="description"
          content="Book Hamburg to Copenhagen train tickets from €29 with Deutsche Bahn & DSB. Discover 2026 schedules, cheap fares, direct EuroCity routes across the Fehmarn Belt (from late 2029), tips, and why the train beats flying."
        />
        <meta property="og:title" content="Hamburg to Copenhagen by Train: Time, Cost & Travel Guide (2026)" />
        <meta property="og:description" content="Direct EuroCity from Hamburg to Copenhagen in ~4h40m – cheap tickets, schedules, tips & FAQs." />
        <meta property="og:url" content="https://www.get-me-there.com/hamburg-to-copenhagen" />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Hamburg to Copenhagen by Train: Time, Cost & Travel Guide (2026)" />
        <meta name="twitter:description" content="Direct EuroCity from Hamburg to Copenhagen in ~4h40m – cheap tickets, schedules, tips & FAQs." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How long does the train from Hamburg to Copenhagen take?",
                acceptedAnswer: { "@type": "Answer", text: "Direct EuroCity trains take around 4 hours 40 minutes (ferry included until late 2029; then ~3h45m via Fehmarn Belt Tunnel)." }
              },
              {
                "@type": "Question",
                name: "Do I need a passport for the Hamburg to Copenhagen train?",
                acceptedAnswer: { "@type": "Answer", text: "Yes – border checks between Germany and Denmark (Schengen, but ID/passport required)." }
              },
              {
                "@type": "Question",
                name: "Can I bring luggage or a bike?",
                acceptedAnswer: { "@type": "Answer", text: "Generous allowance on EuroCity; bikes require reservation (€12)." }
              },
              {
                "@type": "Question",
                name: "When is the best time to book cheap tickets?",
                acceptedAnswer: { "@type": "Answer", text: "Book 3–6 months ahead for €29 Sparpreis Europa fares." }
              },
              {
                "@type": "Question",
                name: "Which side of the train has the best views from Hamburg to Copenhagen?",
                acceptedAnswer: { "@type": "Answer", text: "Right side (facing forward) for Baltic Sea views after the ferry from Puttgarden." }
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Hamburg to Copenhagen by Train", item: "https://www.get-me-there.com/hamburg-to-copenhagen" }
            ]
          })}
        </script>
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
            ...
            <span>→</span>
            <span className="text-blue-300">Hamburg to Copenhagen</span>
          </div>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/60 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-blue-100">Direct EuroCity Train</h2>
                <p className="text-cyan-300 text-sm">Deutsche Bahn & DSB</p>
              </div>

              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <Clock className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
                  <p className="text-3xl font-bold text-white">~4h40m</p>
                  <p className="text-blue-300 text-sm">Direct (incl. ferry)</p>
                </div>
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <p className="text-3xl font-bold text-white">€29–100</p>
                  <p className="text-blue-300 text-sm">One-way (2026 advance fares)</p>
                </div>
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <p className="text-3xl font-bold text-white">5–7 daily</p>
                  <p className="text-blue-300 text-sm">From Hamburg Hbf</p>
                </div>
              </div>
              ...
              <div className="bg-slate-800/60 rounded-2xl p-6">
                ...
                <ul className="text-blue-200/90 space-y-2 text-sm">
                  <li>Sit on the right side (from Hamburg) for best Baltic Sea views after the ferry</li>
                  <li>No reservation compulsory but recommended in summer</li>
                  <li>Bring snacks — onboard bistro available</li>
                  <li>Book early for cheapest Sparpreis Europa fares (limited availability)</li>
                </ul>
              </div>
            </div>
          </section>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-blue-200/80">
                  <tr className="border-b border-blue-400/10">
                    <td className="py-4 px-4 font-semibold text-cyan-300">Train (EuroCity direct)</td>
                    <td className="py-4 px-4">~4h40m</td>
                    <td className="py-4 px-4">€29–100+</td>
          ...
          {/* Schedule */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-6">Hamburg to Copenhagen Schedule</h2>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-3">
              <li>Passport/ID required – border check on train or ferry.</li>
              <li>Seat reservation recommended in summer (€4–6).</li>
              <li>Ferry crossing included – stretch legs on deck.</li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><strong>Scandinavian Starters:</strong> Easy gateway to Denmark & beyond.</li>
              <li><strong>Design & Food Lovers:</strong> Quick to Copenhagen's hygge scene.</li>
              <li><strong>Families:</strong> Fun ferry experience for kids.</li>
              <li><strong>Relaxing Travelers:</strong> Scenic alternative to flying.</li>
            </ul>
          </section>
          ...
          {/* FAQ Section */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-8">FAQs About Hamburg to Copenhagen Train</h2>
            <div className="space-y-6">
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">How long does the train from Hamburg to Copenhagen take?</summary>
                <p className="mt-4 text-blue-200/80">Around 4 hours 40 minutes including ferry (faster from late 2029 with tunnel).</p>
              </details>
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">Do I need a passport?</summary>
                <p className="mt-4 text-blue-200/80">Yes – border checks on train/ferry.</p>
              </details>
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
              ...
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                ...
                <p className="mt-4 text-blue-200/80">3–6 months ahead for €29 Sparpreis Europa tickets.</p>
              </details>
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">Which side has the best views?</summary>
                <p className="mt-4 text-blue-200/80">Right side for Baltic Sea after ferry.</p>
              </details>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <a
                href="https://www.thetrainline.com/en-us/train-times/hamburg-to-copenhagen"
                target="_blank"
              ...
              <a
                href="https://www.omio.com/trains/hamburg/copenhagen"
                target="_blank"
                rel="nofollow noopener"
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              ...
              <div className="space-y-4 text-blue-200/80 leading-relaxed">
                <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on EuroCity with mandatory seat reservation (€4–6).</p>
                <p>Ferry included in pass. Limited passholder seats—book early.</p>
              </div>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              ...
              <li><a href="/hamburg-to-amsterdam" className="text-cyan-300 hover:text-cyan-400">Hamburg to Amsterdam train</a></li>
            </ul>
          </section>
        </main>
