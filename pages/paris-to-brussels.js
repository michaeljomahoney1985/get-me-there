...
export default function ParisToBrussels() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Paris to Brussels</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          One of the fastest and most frequent high-speed connections in Europe—city centre to city centre in just 1 hour 22 minutes.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Eurostar direct train: 1h 22min, from €29 one-way if booked early (up to €150 last-minute). Over 20 departures daily. Book direct on eurostar.com.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">The fastest continental route</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">1h 22min</div>
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Depart Paris Gare du Nord, arrive Brussels-Midi/Zuid. High-speed service (300 km/h). Free Wi-Fi, power sockets, generous luggage allowance (2 large bags + hand luggage, no weight limit).</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Standard: €29-100+ (early booking essential for lowest fares)</li>
                <li>Standard Premier (Plus): €80-150 (wider seats + light meal)</li>
                <li>Business Premier: €250+ (flexible, lounge, full meal)</li>
              </ul>

              <p>Book 4-6 months ahead for €29 fares. Very frequent service—prices rise closer to departure.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  ...
                  <li>Midweek and off-peak cheaper</li>
                  <li>Arrive 20-30 min early (no full border checks like UK routes)</li>
            ...
            <div className="mt-8">
              <a href="https://www.eurostar.com/uk-en/train/paris-to-brussels" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">1h 22min</td>
                  <td className="py-4 px-4">€29-150</td>
                  <td className="py-4 px-4">Everyone—fast & frequent</td>
                </tr>
                <tr className="border-b border-blue-400/10">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Eurostar every time—book early on eurostar.com for €29 fares. With over 20 trains a day, it's incredibly convenient and far better than flying on this short route.
            </p>
          </div>
        </section>
