...
export default function BerlinToPrague() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Berlin to Prague</span>
        </div>
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          ...
          <br />
          <span className="text-blue-100">Direct Train Guide (December 2025)</span>
        </h1>

        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          One of Europe's most popular scenic rail routes—comfortable direct trains from Berlin Hauptbahnhof to Prague Hlavní nádraží along the Elbe River valley.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct EuroCity trains: 4h 20min, from €30 one-way if booked early (up to €100 last-minute). 5-7 departures daily. Book on db.de or cd.cz.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">Direct EuroCity Train</h2>
                <p className="text-cyan-300 text-sm">Deutsche Bahn & Czech Railways</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">€30-100</div>
                <div className="text-sm text-blue-300/70">One-way (Dec 2025)</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <Train className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">5-7 daily</div>
                <div className="text-sm text-blue-300/70">From Hbf</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Comfortable direct EuroCity trains operated jointly by Deutsche Bahn (DB) and Czech Railways (ČD). Scenic route follows the Elbe River through Saxon Switzerland—stunning views of rock formations and valleys.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>2nd Class: €30-70 (Sparpreis Europa early fares)</li>
                <li>1st Class: €50-100 (more space & quieter)</li>
              </ul>

              <p>Book early for cheapest Sparpreis fares (limited availability). Flexible tickets higher. Popular route—sells out in peak seasons.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book on bahn.de or cd.cz (same prices)</li>
                  <li>Sit on the right side (from Berlin) for best Elbe views</li>
            ...
            <div className="mt-8">
              <a href="https://www.bahn.de" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Book on Deutsche Bahn
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes are valid on this route. Seat reservation recommended (€4-6).</p>
              <p>Limited reservation quota for passholders—book early, especially in summer.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                ...
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">~4h 30min</td>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4">4h 20min</td>
                  <td className="py-4 px-4">Pass + €4-6 res.</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Take the direct EuroCity train—book early on bahn.de for €30-40 fares. The scenic Elbe Valley views make this one of Europe's best day-train journeys.
            </p>
          </div>
        </section>
