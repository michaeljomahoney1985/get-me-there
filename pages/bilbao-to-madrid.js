...
export default function BilbaoToMadrid() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Bilbao to Madrid</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          Fast Alvia high-speed service connecting the Basque Country to the capital—direct and comfortable.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Direct Alvia high-speed trains: ~4h 50min-5h 20min, from €25 one-way if booked early (up to €90 last-minute). Around 6-8 departures daily. Book on renfe.com.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-blue-100">Direct Alvia Trains</h2>
                <p className="text-cyan-300 text-sm">Renfe high-speed service</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~4h 50-5h 20min</div>
                <div className="text-sm text-blue-300/70">Direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€25-90</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-sm text-blue-300/70">Abando → Chamartín</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Renfe Alvia high-speed trains (variable-gauge technology for smooth transition from Basque network to high-speed line). Comfortable, Wi-Fi (spotty), power sockets, cafe-bar.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (current 2026 prices):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Básico: €25-55 (early fares)</li>
                <li>Elige: €35-70</li>
                <li>Prémium: €60-90 (meals, lounge access)</li>
              </ul>

              <p>Book early for lowest fares—good value on this near-monopoly route.</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book direct on renfe.com for best price</li>
                  <li>Morning departures popular</li>
                  <li>Arrive 20 min early</li>
                  <li>Bilbao Abando station (central)</li>
                </ul>
              </div>
            </div>

            <div className="mt-8 space-y-4">
              <a href="https://www.thetrainline.com/en/train-times/bilbao-to-madrid" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
                Compare & Book on Trainline
                <Train className="w-5 h-5" />
              </a>
              <a href="https://www.omio.com/trains/bilbao/madrid" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-6 py-3 text-cyan-300 hover:text-cyan-200 underline">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Eurail (non-EU) or Interrail (EU residents) passes valid on Alvia. Seat reservation mandatory (€10-15).</p>
              <p>Good availability—book ahead for busy periods.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">Alvia Train</td>
                ...
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">Slightly faster with airports</td>
                </tr>
                <tr>
                  <td className="py-4 px-4 font-semibold text-cyan-300">Rail Pass</td>
                  <td className="py-4 px-4">~5h</td>
                  <td className="py-4 px-4">Pass + €10-15 res.</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Alvia high-speed train—book early for €25-40 fares. Comfortable, direct, and city-centre stations make it the best way to connect Bilbao and Madrid.
            </p>
          </div>
        </section>
