...
export default function HamburgToBerlin() {
  return (
    <>
      <Head>
        <title>Hamburg to Berlin by Train: Time, Cost & Travel Guide (2026)</title>
        <meta
          name="description"
          content="Book Hamburg to Berlin train tickets from €15 with Deutsche Bahn ICE. Discover 2026 schedules, cheap fares, direct high-speed routes across northern Germany, tips, and why this fast journey is the best way to connect two iconic German cities."
        />
        <meta property="og:title" content="Hamburg to Berlin by Train: Time, Cost & Travel Guide (2026)" />
        <meta property="og:description" content="Direct DB ICE from Hamburg to Berlin in ~2h – cheap advance tickets, frequent departures, northern German landscapes." />
        <meta property="og:url" content="https://www.get-me-there.com/hamburg-to-berlin" />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Hamburg to Berlin by Train: Time, Cost & Travel Guide (2026)" />
        <meta name="twitter:description" content="Direct DB ICE from Hamburg to Berlin in ~2h – cheap advance tickets, frequent departures, northern German landscapes." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How long does the train from Hamburg to Berlin take?",
                acceptedAnswer: { "@type": "Answer", text: "Direct Deutsche Bahn ICE high-speed trains take around 2 hours." }
              },
              {
                "@type": "Question",
                name: "Do I need ID for the Hamburg to Berlin train?",
                acceptedAnswer: { "@type": "Answer", text: "No – domestic German route." }
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: { "@type": "Answer", text: "Book 3–6 months ahead for Sparpreis fares from €15." }
              },
              {
                "@type": "Question",
                name: "Which side of the train has the best views from Hamburg to Berlin?",
                acceptedAnswer: { "@type": "Answer", text: "Both sides offer pleasant northern German countryside – no clear favourite." }
              }
            ]
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Hamburg to Berlin by Train", item: "https://www.get-me-there.com/hamburg-to-berlin" }
            ]
          })}
        </script>
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
            ...
            <span>→</span>
            <span className="text-blue-300">Hamburg to Berlin</span>
          </div>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/60 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-slate-800/70 rounded-2xl p-6 text-center">
                  <p className="text-3xl font-bold text-white">€15–100</p>
              ...
              <div className="bg-slate-800/60 rounded-2xl p-6">
                ...
                <ul className="text-blue-200/90 space-y-2 text-sm">
                  <li>Both sides pleasant northern German views</li>
                  <li>Seat reservation recommended (€5–10)</li>
                  <li>Onboard restaurant serves meals</li>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-blue-200/80">
                  <tr className="border-b border-blue-400/10">
                    ...
                    <td className="py-4 px-4">€15–100+</td>
                  ...
                  <tr className="border-b border-blue-400/10">
                    ...
                    <td className="py-4 px-4">3–4h</td>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-6">Hamburg to Berlin Schedule</h2>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-3">
              <li>No ID checks – domestic German route.</li>
              <li>Seat reservation recommended (€5–10).</li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><strong>City Hoppers:</strong> Fast link between north and capital.</li>
              <li><strong>Culture Fans:</strong> Easy access to Berlin's history and Hamburg's harbour.</li>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <a
                href="https://www.thetrainline.com/en-us/train-times/hamburg-to-berlin"
                target="_blank"
              ...
              <a
                href="https://www.omio.com/trains/hamburg/berlin"
                target="_blank"
                rel="nofollow noopener"
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-blue-100 mb-8">FAQs About Hamburg to Berlin Train</h2>
            <div className="space-y-6">
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">How long does the train from Hamburg to Berlin take?</summary>
                <p className="mt-4 text-blue-200/80">Around 2 hours on fastest ICE services.</p>
              </details>
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
              ...
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                ...
                <p className="mt-4 text-blue-200/80">3–6 months ahead for €15 Sparpreis tickets.</p>
              </details>
              <details className="bg-slate-800/50 rounded-xl p-6 border border-blue-400/20">
                <summary className="text-xl font-semibold text-cyan-300 cursor-pointer">Which side has the best views?</summary>
                <p className="mt-4 text-blue-200/80">Both sides similar flat landscapes.</p>
              </details>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-blue-200/80 space-y-2">
              <li><a href="/berlin-to-hamburg" className="text-cyan-300 hover:text-cyan-400">Berlin to Hamburg (reverse)</a></li>
              <li><a href="/copenhagen-to-hamburg" className="text-cyan-300 hover:text-cyan-400">Copenhagen to Hamburg train</a></li>
