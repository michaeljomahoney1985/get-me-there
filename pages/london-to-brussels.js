    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          The shortest and most frequent Eurostar route—city centre to city centre in under 2 hours, faster than flying door-to-door.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                Eurostar direct train: 1h 53min, from £39 one-way if booked early (up to £180 last-minute). 10-12 departures daily. Book direct on eurostar.com.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">The shortest Eurostar route</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">1h 53min</div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">10-12 daily</div>
                <div className="text-sm text-blue-300/70">From St Pancras</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>Depart London St Pancras International, arrive Brussels-Midi/Zuid. High-speed through the Channel Tunnel (300 km/h). Free Wi-Fi, power sockets, generous luggage allowance (2 large bags + hand luggage, no weight limit).</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Standard: £39-110+ (early booking essential for lowest fares)</li>
                <li>Standard Premier (Plus): £90-180 (wider seats + light meal)</li>
            ...
            <div className="mt-8">
              <a href="https://www.eurostar.com/uk-en/train/london-to-brussels" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">1h 53min</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              Eurostar every time—book early on eurostar.com for £39 fares. It's the fastest door-to-door option, more relaxing than flying, and you arrive right in central Brussels.
            </p>
          </div>
        </section>
