...
export default function LyonToMarseille() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 text-cyan-400 text-sm mb-4">
          ...
          <span>→</span>
          <span className="text-blue-300">Lyon to Marseille</span>
        </div>
        ...
        <p className="text-xl text-blue-200/80 leading-relaxed mb-12">
          High-speed connection from central France to the Mediterranean—comfortable TGV trains from Lyon Part-Dieu to Marseille Saint-Charles.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200/90 leading-relaxed">
                SNCF TGV INOUI / OUIGO direct: ~1h 40min-2h, from €10-16 one-way if booked early (up to €100+ last-minute). Around 18-20 departures daily. Book on sncf-connect.com.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-cyan-300 text-sm">Premium high-speed service</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                ...
                <div className="text-2xl font-bold text-cyan-300">~1h 40min</div>
                <div className="text-sm text-blue-300/70">Fastest direct</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <DollarSign className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">€25-100</div>
                <div className="text-sm text-blue-300/70">One-way (Dec 2025)</div>
              </div>
              <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-400/20">
                <Train className="w-5 h-5 text-cyan-400 mb-2" />
                <div className="text-2xl font-bold text-cyan-300">~18-20 daily</div>
                <div className="text-sm text-blue-300/70">Part-Dieu → St-Charles</div>
              </div>
            </div>

            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              <p>High-speed TGV INOUI from Lyon Part-Dieu to Marseille Saint-Charles. Comfortable seats, free Wi-Fi, power sockets, bar car.</p>

              <p className="font-semibold text-cyan-300">Classes & Prices (approx. Dec 2025):</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>2nd Class: €25-80 (Prems early fares)</li>
                <li>1st Class: €50-100+ (more space & quieter)</li>
              </ul>

              <p>Book early for lowest fares. OUIGO low-cost option often €10-40 (stricter luggage rules).</p>
              ...
              <div className="bg-slate-900/50 border border-cyan-400/30 rounded-xl p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li>Book on sncf-connect.com</li>
                  <li>OUIGO for ultra-low prices</li>
                  <li>Midday trains often cheapest</li>
                  <li>Arrive just minutes before—no security</li>
                </ul>
              </div>
            </div>

            <div className="mt-8">
              <a href="https://www.sncf-connect.com/en-en/train/route/lyon/marseille" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-xl font-semibold text-white shadow-lg transition-all duration-300">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-slate-800/90 to-blue-900/50 backdrop-blur-xl rounded-3xl p-8 border border-blue-400/20">
            ...
            <div className="space-y-4 text-blue-200/80 leading-relaxed">
              ...
              <p>Good availability on this route—book ahead for peak times.</p>
            </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-blue-200/80">
                <tr className="border-b border-blue-400/10">
                  ...
                  <td className="py-4 px-4">Comfort & speed</td>
                </tr>
                <tr className="border-b border-blue-400/10">
                  <td className="py-4 px-4 font-semibold text-cyan-300">OUIGO</td>
                  <td className="py-4 px-4">~1h 50min</td>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-400/30 rounded-2xl p-8">
            ...
            <p className="text-blue-200/90 text-lg leading-relaxed">
              TGV INOUI for comfort—book early for €25+ fares. OUIGO if maximizing savings (€10-30 common). Train is far superior to bus or flight on this route.
            </p>
          </div>
        </section>
